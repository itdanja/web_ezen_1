...
////////////////////////////////////////////////////////////////////
			for (int i = 0; i < 게임판.length; i++) { // 게임판 출력 3개마다 줄바꿈
...
////////////////////////////////////////////////////////////////////
		...
		if (count == 9) { // 현재 알수가 9개 이면 무승부 처리 
		...
		for (int i = 0 ; i<=6 ; i+=3 ) {// 선생님거랑 어떤차이가있는지
		...
		for (int i = 0; i <=2; i+=1) { // 선생님거랑 어떤차이가있는지
